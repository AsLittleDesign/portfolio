...
(function() {
  var collide, debounce, randomNumber, renderBubbles, viewItem, work;

  work = [
    {
      id: "recharge",
      title: "Recharge App Marketing Page",
      thumbnailPath: "/assets/thumbnails/recharge-9bea7b520cc76fbcaf54c98f878846bf.jpg",
      imagePath: "/assets/work/recharge-a2115170716f2d60d5ef06c3886b11ef.jpg",
      color: "#d3d1ca"
    }, {
      id: "jobs",
      title: "Steve Jobs Portrait",
      thumbnailPath: "/assets/thumbnails/jobs-bd7b1451a697bffe73820a43b839842b.jpg",
      imagePath: "/assets/work/jobs-71882d36fc11ea75141ab69ae562de02.jpg",
      color: "#a8a8aa"
    }, {
      id: "faraway",
      title: "Far Away",
      thumbnailPath: "/assets/thumbnails/faraway-f97c3e736086d5cc7fc13acd6dc516e4.jpg",
      imagePath: "/assets/work/faraway-c4449bc5201afe452ee48af8166e5a95.jpg",
      color: "#c2a071"
    }, {
      id: "yoda",
      title: "When nine hundred years old you reach, look as good you will not.",
      thumbnailPath: "/assets/thumbnails/yoda-853d1e1efa02a03b596f7481da3846de.jpg",
      imagePath: "/assets/work/yoda-4938f421de400f8de2b22875465505f5.jpg",
      color: "#e6e6e6"
    }, {
      id: "watch",
      title: "Moto 360 Watch Face",
      thumbnailPath: "/assets/thumbnails/watch-e5b3732ec79f9436f740b7175e411a28.png",
      imagePath: "/assets/work/watch-5923d2f01246f3fd05584dc6b7614466.gif",
      color: "#373736"
    }, {
      id: "bee",
      title: "Work",
      thumbnailPath: "/assets/thumbnails/bee-398d46a1129447166dfbf428e1de3c45.jpg",
      imagePath: "/assets/work/bee-37a386014dfe43295e80d2defaef8cac.jpg",
      color: "#aeae97"
    }, {
      id: "cliff",
      title: "El Capitan",
      thumbnailPath: "/assets/thumbnails/cliff-f78d952811586ac123e33557dfbe46d1.jpg",
      imagePath: "/assets/work/cliff-5a5cb5841249ee045f15a4f4837e2c4d.jpg",
      color: "#868686"
    }, {
      id: "dragonfly",
      title: "Emerald Insect",
      thumbnailPath: "/assets/thumbnails/dragonfly-c60c7f8844a71e1fd5eb03598796896b.jpg",
      imagePath: "/assets/work/dragonfly-4095f2c46e5fa0e846dfda1f859123b3.jpg",
      color: "#89884a"
    }, {
      id: "eye",
      title: "Window to the Soul",
      thumbnailPath: "/assets/thumbnails/eye-20d0049a9ff7ed183a0a6a4777094dbb.jpg",
      imagePath: "/assets/work/eye-8f7d50bc207b1082f5e93b89581dad41.jpg",
      color: "#68331f"
    }, {
      id: "incense",
      title: "Smoke (no mirrors)",
      thumbnailPath: "/assets/thumbnails/incense-d0847fcd31ce4ccd6a28793929d78928.jpg",
      imagePath: "/assets/work/incense-c243d7a8c537caca35f7cc5903e407bb.jpg",
      color: "#333333"
    }, {
      id: "megan",
      title: "Megan",
      thumbnailPath: "/assets/thumbnails/megan-7a89ae7dfdf41020eb541039dfb8b796.jpg",
      imagePath: "/assets/work/megan-ee183c420e46bddf82c86694de4d9b8e.jpg",
      color: "#d8d8d8"
    }, {
      id: "tree",
      title: "Solitude",
      thumbnailPath: "/assets/thumbnails/tree-dbb68839a232cf37ee6c7f9e33b1159f.jpg",
      imagePath: "/assets/work/tree-c0df73e5c4cf7544cb3795ffd53e5f2c.jpg",
      color: "#747474"
    }, {
      id: "alarm",
      title: "Smart Alarm App Concept",
      thumbnailPath: "/assets/thumbnails/alarm-f1e5c7925f8cfb964f88c85370847e64.jpg",
      imagePath: "/assets/work/alarm-2f2cdc0a070238ced65244296852d644.jpg",
      color: "#8d8c89"
    }, {
      id: "fistbump",
      title: "Fist Bump App Concept",
      thumbnailPath: "/assets/thumbnails/fistbump-291d2f8e5c3d40a1d5f1ec580de6372a.jpg",
      imagePath: "/assets/work/fistbump-9b8b2183f06d01b25f8fefb751a3000d.jpg",
      color: "#63b5e5"
    }
  ];
  ...
  viewItem = function(d) {
    var content, textColor;
    d3.selectAll('.node').transition().duration(200).ease("linear").attr("r", 0);
    textColor = tinycolor.isReadable(d.color, tinycolor(d.color).lighten(40)) ? tinycolor(d.color).lighten(40) : tinycolor.isReadable(d.color, tinycolor(d.color).darken(50)) ? tinycolor(d.color).darken(40) : "rgba(255, 255, 255, 0.7)";
    content = "<div class='view-item--image-background' style='background-image: url(" + d.imagePath + ")'></div> <div class='view-item--content container centered'> <img src='" + d.imagePath + "' class='view-item--image' /> <h1>" + d.title + "</h1> <p>" + (d.description || '') + "</p> </div> <span class='view-item--back' js-item-back>Back</span>";
    ...
    setTimeout(function() {
      return $("[js-view-item]").css("opacity", 1);
    }, 250);
    return $("[js-item-back]").click(function() {
      $("[js-navigation]").removeAttr("s-transparent");
      $("[js-view-item]").css("pointer-events", "none").css("opacity", 0);
      return d3.selectAll(".node").attr("r", function(d) {
        return d.r;
      });
    });
  };
  ...
  renderBubbles = function() {
    var animateRadius, defs, force, height, j, len, moveGravity, node, nodeDuplicate, svg, svgDuplicate, width;
    height = $(window).height();
    width = $(window).width();
    svg = d3.select("[js-svg-append]").append("svg").attr({
      "version": "1.1",
    ...
    for (j = 0, len = work.length; j < len; j++) {
      node = work[j];
    ...
    force = d3.layout.force().nodes(work).size([width, height]).friction(0.9).gravity(0.02).theta(0.8).alpha(0.1);
    node = svg.selectAll('.node').data(work).enter().append('circle').attr({
      "class": "node",
      "r": function(d) {
        return d.r;
      },
    ...
    svgDuplicate = d3.select("[js-duplicate-svg]").append("svg").attr({
      "version": "1.1",
      "xmlns": "http://www.w3.org/2000/svg",
      "xml:space": "preserve",
      "width": "100%",
    ...
    nodeDuplicate = svgDuplicate.selectAll('.node').data(work).enter().append('circle').attr({
      "class": "node",
      "r": function(d) {
        return d.r;
      },
    ...
    animateRadius = function(node, d) {
      d3.select(node).transition().attr("r", d.r).duration(1000).ease("elastic");
      return d3.select(nodeDuplicate[0][d.index]).transition().attr("r", d.r).duration(1000).ease("elastic");
    };
    ...
    $(window).resize(function() {
      height = $(window).height();
      width = $(window).width();
      return force.size([width, height]);
    });
    $("[js-svg-append]").on("mousemove", function() {
      width = event.clientX * 2;
      height = event.clientY * 2;
      return moveGravity(width, height);
    ...
    moveGravity = function(width, height) {
      return force.size([width, height]).gravity(0.005).resume();
    };
    return force.start();
  };
